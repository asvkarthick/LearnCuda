/* Program to add two arrays in GPU using multiple blocks and multiple threads
   nvcc program-006.cu
 */
#include <iostream>
#include <cuda_runtime.h>

// Number of elements to add is 10000
#define N 10000
...
int main() {
    ...
    std::cout << "Program to demonstrate parallel programming in GPU with multiple blocks and multiple threads" << std::endl;
